...
interface SearchRepo {
    ...
    fun searchSpeciesWithCategory(query: String, categoryType: CategoryType, categoryId: Int): Flow<PagingData<SpeciesDetail>>

    fun searchCategory(query: String, categoryType: CategoryType): Flow<PagingData<CategoryData>>

    fun searchCategory(query: String, categoryType: CategoryType, categoryId: Int): Flow<PagingData<CategoryData>>
